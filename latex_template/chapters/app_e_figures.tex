...
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_preprocessing}}      & \textcolor{textmuted}{\small Bluesky NLP}        & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small LDA preprocessing summary}                & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_preprocessing}} \\\hline
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_dictionary}}         &                                                    & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small Vocabulary size and filter metrics}       & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_dictionary}} \\\hline
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_top_terms}}          &                                                    & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small Top 15 terms by document frequency}       & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_top_terms}} \\\hline
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_coherence_sweep}}    &                                                    & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small Coherence and AIC sweep (K=2 to 10)}     & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_coherence_sweep}} \\\hline
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_model_summary}}      &                                                    & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small Final LDA model parameters}              & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_model_summary}} \\\hline
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_topic_words}}        &                                                    & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small Top 10 words per topic}                  & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_topic_words}} \\\hline
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_wordclouds}}         &                                                    & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small Topic-specific word clouds}              & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_wordclouds}} \\\hline
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_topics_time}}        &                                                    & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small Topic prominence over time}              & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_topics_time}} \\\hline
\textcolor{textmuted}{\small\ref{fig:bsky_nlp_topics_buzz}}        &                                                    & \textcolor{textmuted}{\small Bluesky}         & \textcolor{textmuted}{\small Topic distribution by buzz cluster}       & \textcolor{textmuted}{\small\pageref{fig:bsky_nlp_topics_buzz}} \\\hline
...
% ----- 7. Predictive -----
\multicolumn{5}{|l|}{\rule[-0.3em]{0pt}{1.2em}\textcolor{textprimary}{\sffamily\bfseries\small\enspace 7 \enspace Predictive}} \\
\hline
...
\centering
\vspace*{\fill}
\captionof{table}{Bluesky LSA concepts and dominant loading terms.}
\label{tab:bsky_concepts}
\vspace{0.5em}
\includegraphics[width=0.97\linewidth]{figures/bluesky/tables/concept_df.png}
\vspace*{\fill}
\end{landscape}
...
% ------------------------------------------------------------------
\subsubsection{Bluesky NLP Topic Modeling}
