...
\includegraphics[width=\textwidth,height=0.40\textheight,keepaspectratio]{centrality_landscape.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{normal_distributions_sentiment_scores.png}
\caption{KDE distributions of sentiment scores per method and media-leaning group, with a secondary projection by candidate focus (TrumpBuzz vs.\ HarrisBuzz).}
...
\small
\begin{tabular}{>{\color{white}}p{2cm} >{\color{white}}p{2.5cm} >{\color{white}}p{4.5cm} >{\color{white}}p{3cm} >{\color{white}}p{2.5cm}}
\toprule
...
\small
\begin{tabular}{>{\color{white}}c >{\color{white}}p{2.5cm} >{\color{white}}c >{\color{white}}p{3cm} >{\color{white}}p{5.5cm}}
\toprule
...
\begin{table}[H]
\centering
\includegraphics[width=\textwidth]{predictive/table_leaderboard_1of2.png}
\caption{Model leaderboard: test-set performance for all model--feature set combinations (part 1 of 2).}
\label{tab:results}
\end{table}

\begin{table}[H]
\centering
\includegraphics[width=\textwidth]{predictive/table_leaderboard_2of2.png}
\caption{Model leaderboard: test-set performance for all model--feature set combinations (part 2 of 2).}
\label{tab:results_2}
\end{table}
